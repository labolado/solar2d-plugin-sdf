...
-- ─────────────────────────────────────────────
-- Override system
-- Returns SDF proxy objects that are now fully compatible with
-- widgets, transitions, physics, etc. thanks to transparent
-- property forwarding to the underlying display group.
-- ─────────────────────────────────────────────
